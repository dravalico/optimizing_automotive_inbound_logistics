...
C_i_dR =  # Rental cost for load carriers for supplier i in L to satisfy one day's demand [€]
C_i_dI =  # Investment cost for load carriers supplier i in L to satisfy one day's demand [€]
