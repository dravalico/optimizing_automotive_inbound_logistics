import numpy as np
from src.dataset.generation.lognormal_distribution import generate_samples, generate_lognormal_distribution_samples
...
plot_lognormal_distribution(1.41, 3439.98, 280573.60, 570)
